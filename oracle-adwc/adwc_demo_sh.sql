...
CREATE TABLE adwc_demo.salestemp (
    prod_id             NUMBER          NOT NULL,
    cust_id             NUMBER          NOT NULL,
    time_id             DATE            NOT NULL,
    channel_id          NUMBER          NOT NULL,
...
CREATE TABLE adwc_demo.products (
...
CREATE TABLE adwc_demo.channels (
    channel_id                  NUMBER          NOT NULL,
...
CREATE TABLE adwc_demo.promotions (
...
CREATE TABLE adwc_demo.customers (
    cust_id                     NUMBER          NOT NULL,
...
CREATE TABLE adwc_demo.countries (
    country_id                  NUMBER          NOT NULL,
...
CREATE TABLE adwc_demo.supplementary_demographics
  ( CUST_ID          NUMBER not null,
...
ALTER TABLE adwc_demo.promotions
  ADD CONSTRAINT promo_pk
  PRIMARY KEY (promo_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE adwc_demo.sales
  ADD CONSTRAINT sales_promo_fk
  FOREIGN KEY (promo_id) REFERENCES adwc_demo.promotions (promo_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE adwc_demo.costs
  ADD CONSTRAINT costs_promo_fk
  FOREIGN KEY (promo_id) REFERENCES adwc_demo.promotions (promo_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE adwc_demo.customers
...
ALTER TABLE adwc_demo.sales
  ...
  FOREIGN KEY (cust_id) REFERENCES adwc_demo.customers (cust_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE adwc_demo.products
...
ALTER TABLE adwc_demo.sales
  ...
  FOREIGN KEY (prod_id) REFERENCES adwc_demo.products (prod_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE adwc_demo.sales
  ...
  FOREIGN KEY (time_id) REFERENCES adwc_demo.times (time_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE adwc_demo.channels
...
ALTER TABLE adwc_demo.sales
  ...
  FOREIGN KEY (channel_id) REFERENCES adwc_demo.channels (channel_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE adwc_demo.countries
...
ALTER TABLE adwc_demo.customers
  ...
  FOREIGN KEY (country_id) REFERENCES adwc_demo.countries (country_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE adwc_demo.supplementary_demographics
